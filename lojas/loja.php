<?php
  ...
  if (isset($_GET['id']) && !empty($_GET['id']) ) {
    ...
    $loja     = $a->buscarLojaPorId($id);
    $galeria  = $a->galeriaLoja($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../Administrador/aba/imagens/<?php echo $v['nomeImgLoja']; ?>" alt="">
                </div>
                <?php
                  }
                ?>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              ?>
              <h3><img src="../Administrador/aba/imagens/<?php echo $value['capaLoja']; ?>" class="img-thumbnail"  alt="..."></h3>
              <div class="portfolio-description">
                <h2><?php echo $value['nomeLoja'];?><a href="<?php echo $value['instaLoja']; ?>" class="instagram"><i class="bx bxl-instagram"></i></a> <a href="<?php echo $value['faceLoja']; ?>" class="facebook"><i class="bx bxl-facebook"></i></a>
                </h2>
                <p><?php echo $value['descricaoLoja']; ?></p>
                <a class="whatsapp-link" href="https://api.whatsapp.com/send?phone=55<?php echo$value['whatsLoja']; ?>" target="_blank"><i class="bi bi-whatsapp icone-whatsapp"></i> </a>
                <?php
                  if($value['freteLoja'] == 'Sim'){ 
                ?>
                <hr>
                Faço o Cadastro e tenha frete grátis!
                <a href="frete.php?id=<?php echo $value['idLoja'] ?>" target="_blank" class="text-white">
  ...
  <section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <div class="row portfolio-container"  data-aos-delay="200">
        ...
        ?>
        <a href="../Administrador/aba/imagens/<?php echo $img['nomeImgLoja'];?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" >
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="../Administrador/aba/imagens/<?php echo $img['nomeImgLoja'];?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>App 1</h4>
              <p>App</p>            
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-contact">
            ...
            ?>
              <img src="../Administrador/aba/imagens/<?php echo $footer['capaLoja']; ?>" class="img-thumbnail" alt="...">
              <br>
            <?php
              }
            ?>
