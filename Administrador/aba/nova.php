            ...
            <div class="card-body">
              ...
              <?php
                ...
                if(isset($_POST['nome'])){
                  ...
                  $fk_idAba     = addslashes($_POST['fk_idAba']);
                  ...
                  if ($a->cadastrarNovaLoja($fotos, $nome, $descricao, $whats, $face, $insta, $localizacao, $frete, $fk_idAba) == true) {
                    echo "<script> Loja já Cadastrada! Cadastre Uma nova Loja</script>";
                            header('location: cadastro.php');
                            die();
                  }else if((!empty($nome))){
                    if (!$a->cadastrarNovaLoja($fotos, $nome, $descricao, $whats, $face, $insta, $localizacao, $frete, $fk_idAba)) {
              ...
              <form class="row g-3"  method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <input name="whats" type="number" class="form-control" id="inputName5">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Aba</label>
                  <select id="inputState" class="form-select" name="fk_idAba">
                    <?php $a->buscarAbaLoja();?>
                  </select>
                </div>
