            ...
            <div class="card-body">
              ...
              <?php
                ...
                if(isset($_POST['nome'])){
                  ...
                  if ($l->cadastrarLojaRuaBiquinis($fotos, $nome, $descricao, $whats, $face, $insta, $localizacao, $frete) == true) {
                    echo "<script> Loja já Cadastrada! Cadastre Uma nova Loja</script>";
                            header('location: cadastro.php');
                            die();
                  }else if((!empty($nome))){
                    if (!$l->cadastrarLojaRuaBiquinis($fotos, $nome, $descricao, $whats, $face, $insta, $localizacao, $frete)) {
