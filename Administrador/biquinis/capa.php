<?php
  ...
  if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $img  = $l->buscarCaparRuaBiquinisPorId($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
            ...
            <div class="card-body">
              ...
              <?php
                if (isset($_GET['id']) && !empty($_GET['id'])) {
                  ...
                  if($l->capaLojaRuaBiquinis($id, $capa) == true){
                    echo "<script>alert('Capa atualizada!')</script>";
                  }
                }                
              ?>
              ...
              <form class="row g-3"  method="POST" enctype="multipart/form-data">
                ...
                ?>
                <div class="col-md-12">
                    <img class="img-thumbnail"  alt="..." src="imagens/<?php echo $v['capaBiquinis']; ?>">
                </div>
                <?php
                  }
                ?>
