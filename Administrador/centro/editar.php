    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Editar <?php echo $loja['nomeCentro']; ?></h5>
                <?php
                    if (isset($_POST['nome'])) {
                        if (isset($_GET['id']) && !empty($_GET['id']) ) {
                            $id           = addslashes($_GET['id']);
                            ...
                            if ($l->editarLojaCentro($id, $nome, $descricao, $whats, $face, $insta, $localizacao, $frete) == true) {
              ...
              <form class="row g-3"  method="POST">
                <div class="col-md-12">
                  ...
                  <input name="nome" type="text" class="form-control" id="inputName5" value="<?php echo $loja['nomeCentro']; ?>">
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Descrição</label>
                  <textarea name="descricao" cols="30" rows="5" type="text" class="form-control" id="inputName5"><?php echo $loja['descricaoCentro']; ?></textarea>
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Whatsapp</label>
                  <input name="whats" type="text" class="form-control" id="inputName5"  value="<?php echo $loja['whatsCentro']; ?>">
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Facebook</label>
                  <input name="face" type="text" class="form-control" id="inputName5"  value="<?php echo $loja['faceCentro']; ?>">
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Instagram</label>
                  <input name="insta" type="text" class="form-control" id="inputName5"  value="<?php echo $loja['instaCentro']; ?>">
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Localização</label>
                  <textarea name="localizacao" type="text" class="form-control" id="inputName5"><?php echo $loja['localizacaoCentro'] ?></textarea>
                </div>
                <div class="col-md-12">
                  <label for="inputName5" class="form-label fw-bold">Ativar Botão Frete Gratis</label>
                  <input name="frete" type="text" class="form-control" id="inputName5"  value="<?php echo $loja['freteCentro']; ?>">
                </div>
