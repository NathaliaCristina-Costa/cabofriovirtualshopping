            ...
            <div class="card-body">
              ...
              <?php
               if (isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                if($p->logoParceiros($id, $capa) == true){
              ...
              <form class="row g-3"  method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <label for="inputEmail5" class="form-label"><b>Logo</b></label>
                ...
                ?>
                <div class="col-md-12">
                    <img class="img-thumbnail"  alt="..." src="imagens/<?php echo $v['logo']; ?>">
                </div>
                <?php
                  }
                ?>
