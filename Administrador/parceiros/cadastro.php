  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Novo Parceiro</h5>
              ...
              <?php
                if (isset($_POST['nome'])) {
                  ...
                  if ($p->cadastroParceiro($nome,$link) == true) {
                    echo "<script> Parceiro já Cadastrado! Cadastre Uma nova Loja</script>";
                            header('location: cadastro.php');
                            die();
                  }else if(!empty($nome)){
                    if (!$p->cadastroParceiro($nome,$link)) {
