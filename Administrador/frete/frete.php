            ...
            <div class="card-body pt-3">
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <h5 class="card-title">Loja - <?php echo $loja['nomeJardim']; ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $loja['estado']; ?></div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Cidade</div>
                    <div class="col-lg-9 col-md-8"><?php echo $loja['cidade']; ?></div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">CEP</div>
                    <div class="col-lg-9 col-md-8"><?php echo $loja['cep']; ?></div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Endereço</div>
                    <div class="col-lg-9 col-md-8"><?php echo $loja['endereco']; ?></div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Bairro</div>
                    <div class="col-lg-9 col-md-8"><?php echo $loja['bairro']; ?></div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Telefone</div>
                    <div class="col-lg-9 col-md-8"><?php echo $loja['telefone']; ?></div>
                  </div>
