<?php
    ...
    $l = new Loja();
    $lojas  = $l->buscarGradeLojaTamoios();
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
            ...
            <div class="container">
                ...
                <div class="row row-cols-2 row-cols-md-2 justify-content-center">
                    ...
                    <div class="col-md-4 col-lg-2 mb-5">
                        <a href="loja.php?id=<?php echo $k['idTamoios'];?>">
                            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                                ...
                                <img class="img-thumbnail" src="../Administrador/tamoios/imagens/<?php echo $k['capaTamoios']; ?>"  alt="..." />
                            </div>
                        </a>
                    </div>
                    <?php
