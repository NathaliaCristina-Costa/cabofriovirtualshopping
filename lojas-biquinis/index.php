<?php
    ...
    $l = new Loja();
    $lojas  = $l->buscarGradeLojaRuaBiquinis();
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <title>Lojas / Rua dos Biquínis</title>
        <!-- Favicon-->
            ...
            <div class="container">
                ...
                <div class="row row-cols-2 row-cols-md-2 justify-content-center">
                    ...
                    <div class="col-md-4 col-lg-2 mb-5">
                        <a href="loja.php?id=<?php echo $k['idBiquinis'];?>">
                            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                                ...
                                <img class="img-thumbnail" src="../Administrador/biquinis/imagens/<?php echo $k['capaBiquinis']; ?>"  alt="..." />
                            </div>
                        </a>
                    </div>
                    <?php
