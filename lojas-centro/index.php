...
<html lang="pt-br">
    <head>
        ...
        <title>Lojas / Centro Cabo Frio</title>
        <!-- Favicon-->
            ...
            <div class="container">
                ...
                <div class="row row-cols-2 row-cols-md-2 justify-content-center">
                    ...
                    <div class="col-md-4 col-lg-2 mb-5">
                        <a href="loja.php?id=<?php echo $k['idCentro'];?>">
                            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                                ...
                                <img class="img-thumbnail" src="../Administrador/centro/imagens/<?php echo $k['capaCentro']; ?>"  alt="..." />
                            </div>
                        </a>
                    </div>
                    <?php
