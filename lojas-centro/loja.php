<?php
  ...
  if (isset($_GET['id']) && !empty($_GET['id']) ) {
    ...
    $loja     = $l->buscarLojaCentroPorId($id);
    $galeria  = $l->galeriaLojaCentro($id);
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../Administrador/centro/imagens/<?php echo $v['nomeImgCentro']; ?>" alt="">
                </div>
                <?php
                  }
                ?>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              ?>
              <h3><img src="../Administrador/centro/imagens/<?php echo $value['capaCentro']; ?>" class="img-thumbnail"  alt="..."></h3>
              <div class="portfolio-description">
                <h2><?php echo $value['nomeCentro'];?><a href="<?php echo $value['instaCentro']; ?>" class="instagram"><i class="bx bxl-instagram"></i></a> <a href="<?php echo $value['faceCentro']; ?>" class="facebook"><i class="bx bxl-facebook"></i></a>
                </h2>
                <p><?php echo $value['descricaoCentro']; ?></p>
                <a class="whatsapp-link" href="https://api.whatsapp.com/send?phone=55<?php echo$value['whatsCentro']; ?>" target="_blank"><i class="bi bi-whatsapp icone-whatsapp"></i> </a>
                <?php
                  if($value['freteCentro'] == 'Sim'){ 
                ?>
                <hr>
                Faço o Cadastro e tenha frete grátis!
                <a href="frete.php?id=<?php echo $value['idCentro'] ?>" target="_blank" class="text-white">
  ...
  <section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <div class="row portfolio-container"  data-aos-delay="200">
        ...
        ?>
        <a href="../Administrador/centro/imagens/<?php echo $img['nomeImgCentro'];?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" >
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="../Administrador/centro/imagens/<?php echo $img['nomeImgCentro'];?>" class="img-fluid" alt="">
  ...
  <div class="container">
    <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-contact">
            ...
            ?>
              <img src="../Administrador/centro/imagens<?php echo $footer['capaCentro']; ?>" class="img-thumbnail" alt="...">
              <br>
            <?php
              }
            ?>
